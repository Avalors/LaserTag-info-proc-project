...
public class CameraController : MonoBehaviour
{
    ...
    void Start()
    {   
        FPGA = FindObjectOfType<FPGAController>();
    ...
    void Update()
    {
        ...
        //gets mouse input
        float mouseX = FPGA.accolerometer_y * Time.deltaTime * sensX;
        float mouseY = FPGA.accelerometer_x * Time.deltaTime * sensX;
